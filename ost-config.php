...
define('SECRET_SALT','K2a4Ro480oTGyM48eCMt0b=ObBLGcdga');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','daris.bischof@edu.gbssg.ch');
...
define('DBHOST','10.0.1.135');
define('DBNAME','osTicketDB');
define('DBUSER','root');
define('DBPASS','Riethuesli>12345!');
